 ...
 * (delivery.soldi.kiev.ua) на задану дату і парсить її через {@link HtmlTableParser}. Незалежне від сисадміна — карта
 * колонок фіксована ззовні, працює вже сьогодні, оскільки {@link HtmlTableParser} вже готовий і покритий тестами.
 * Мінус: адреса — вільний текст без гарантії коректних координат (див. блок "Ринки, стройки і промзони" в
 * AI_CONTEXT.md).</li>
