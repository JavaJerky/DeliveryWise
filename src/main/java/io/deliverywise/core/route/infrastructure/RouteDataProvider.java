...
/**
 * Contract for decoupling data ingestion (HTML/1C/WMS) from the core routing engine.
 * Контракт для ізоляції джерел даних (HTML/1C/WMS) від ядра оптимізації маршрутів.
 *
