...
* **OSRM / GraphHopper** — Двигуни обчислення геопросторових матриць. Розраховують реальні дорожні відстані та часові проміжки по картах України (OpenStreetMap data), повністю замінюючи примітивну геометричную дистанцію (Хаверсин).
* **pgRouting** — Використовується для побудови внутрішніх топологічних графів мережі та додаткового просторового аналізу безпосередньо всередині СУБД.
